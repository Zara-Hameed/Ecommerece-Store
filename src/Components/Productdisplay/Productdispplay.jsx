    ...
    <div className="productdisplay">
      ...
      <div className="productdisplay-right">
        ...
        <div className="productdisplay-description">
          ...
          commodi quaerat nemo, architecto doloribus, voluptates tenetur sed
          magnam veniam ipsum error, aperiam iusto aut rerum quidem 
          numquam quia est.
        </div>
...
export default Productdispplay;
